...
![](../Go/images/Pasted%20image%2020230711100440.png)
### 控制器

其中，控制器有 4 个比较重要的功能
![](../Go/images/Pasted%20image%2020230711100608.png)
- 红色圆点的按钮，表示“开始 / 暂停抓包”。
...
![根据属性排序](../Go/images/Pasted%20image%2020230711100955.png)
#### 2. 详细信息
如果你选中详细列表中的一项，右边就会出现该项的详细信息，如下所示：

![详细请求信息](../Go/images/Pasted%20image%2020230711101017.png)
...
![浏览器中 HTTP 请求流程](../Go/images/Pasted%20image%2020230711101059.png)
...
![单个文件的时间线](../Go/images/Pasted%20image%2020230711101656.png)
